...
#for n in range(2):
 ...
 # Em Python podemos criar inclise funções e executar através da variavél nomeada
minha_terceira_funcao = minha_segunda_funcao  # Essa terceira forma não é utilizada
minha_terceira_funcao()
