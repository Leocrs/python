...
pyautogui.write('https://drive.google.com/drive/folders/SEU USUARIO GOOGLE DRIVE') # escreva o link do arquivo
pyautogui.press('enter') # clica no enter
time.sleep(1) # espera 1 segundo
...
time.sleep(1) # espera 1 segundo    
pyautogui.typewrite(r" C:\Users\SEU USUARIO\Documents\backup ") # OBS: "r" é necessario para o Python abrir qualquer caminho sem inventar "moda"
pyautogui.press('enter') # clica no enter
